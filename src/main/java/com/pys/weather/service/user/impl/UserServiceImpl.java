...
import com.pys.weather.jwt.JwtTokenProvider;
...
public class UserServiceImpl implements UserService {
    ...
    public UserInfoResponse findUserInfo() {
        ...
        if (authentication == null || authentication.getName() == null) {
            ...
            throw new CustomException(ErrorEnum.AUTHENTICATION_INFORMATION_NOT_FOUND);
        }
        ...
        return userRepository.findByUserNm(authentication.getName())
                ...
                .orElseThrow(() -> {
                    ...
                    return new CustomException(ErrorEnum.USER_NOT_FOUND);
                });
    }
    ...
    public void regUser(SignUpRequest request) {
        ...
        if (users.isPresent()) {
            throw new CustomException(ErrorEnum.CAN_NOT_USE_NAME);
        }
        // Password 암호화
